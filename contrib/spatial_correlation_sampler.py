#
# See external_packages/spatial_correlation_sampler..
#
...
class Correlation(nn.Module):
    def __init__(self, kernel_size=1, patch_size=9, stride=1, padding=0, dilation=1, dilation_patch=1):
        super().__init__()
        self.patch_size = patch_size
    ...
    def forward(self, input1, input2):
        result = self.sampler(input1, input2)
        b, _, _, h, w = result.size()
        return result.view(b, self.patch_size ** 2, h, w)
