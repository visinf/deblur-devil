...
class _Sintel(data.Dataset):
    def __init__(self,
        ...
        images_root = os.path.expanduser(images_root)
        flow_root = os.path.expanduser(flow_root)
        self._args = args
        ...
        for base_folder in base_folders:
            img_filenames = list(filter(lambda x: base_folder in x, all_img_filenames))
            flo_filenames = []
            if flow_root is not None:
                flo_filenames = list(filter(lambda x: base_folder in x, all_flo_filenames))
    ...
    def __getitem__(self, index):
        ...
        # example filename
        # filename = os.path.basename(im1_filename)[:5]
...
class SintelTrainingCleanTrain(_Sintel):
    def __init__(self, args, root, num_workers=4, num_examples=-1):
...
factory.register("SintelTrainingCleanTrain", SintelTrainingCleanTrain)
factory.register("SintelTrainingCleanValid", SintelTrainingCleanValid)
factory.register("SintelTrainingCleanFull", SintelTrainingCleanFull)

factory.register("SintelTrainingFinalTrain", SintelTrainingFinalTrain)
factory.register("SintelTrainingFinalValid", SintelTrainingFinalValid)
factory.register("SintelTrainingFinalFull", SintelTrainingFinalFull)

factory.register("SintelTestClean", SintelTestClean)
factory.register("SintelTestFinal", SintelTestFinal)
